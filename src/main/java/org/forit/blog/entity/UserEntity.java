...
public class UserEntity implements Serializable {
    ...
    public UserEntity(long ID, String nome, String cognome, String username, String email, String password, LocalDate dataRegistrazione, LocalDate dataUltimoAccesso, boolean attivo, int tentativi, boolean bloccato, int idRuolo) {
        this.ID = ID;
        this.nome = nome;
    ...
    public int hashCode() {
        ...
        hash = 67 * hash + Objects.hashCode(this.cognome);
        hash = 67 * hash + Objects.hashCode(this.username);
        hash = 67 * hash + Objects.hashCode(this.email);
        hash = 67 * hash + Objects.hashCode(this.password);
        hash = 67 * hash + Objects.hashCode(this.dataRegistrazione);
        hash = 67 * hash + Objects.hashCode(this.dataUltimoAccesso);
        hash = 67 * hash + (this.attivo ? 1 : 0);
        hash = 67 * hash + this.tentativi;
        hash = 67 * hash + (this.bloccato ? 1 : 0);
        hash = 67 * hash + this.idRuolo;
        return hash;
    }
