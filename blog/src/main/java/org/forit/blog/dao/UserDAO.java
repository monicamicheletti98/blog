...
public class UserDAO {
    ...
    public void insertUser(long ID, String nome, String cognome, String username, String email, String password, LocalDate dataRegistrazione, LocalDate dataUltimoAccesso, boolean attivo, int tentativi, boolean bloccato, long idRuolo) throws BlogException {
    ...
    public void updateUser(long ID, String nome, String cognome, String username, String email, String password, LocalDate dataRegistrazione, LocalDate dataUltimoAccesso, boolean attivo, int tentativi, boolean bloccato,  long idRuolo) throws BlogException {
        try (
                Connection conn = DriverManager.getConnection(DB_URL);
