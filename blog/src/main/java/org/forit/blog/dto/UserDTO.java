...
public class UserDTO {
    ...
    public UserDTO(long id, String nome, String cognome, String username, String email, String password, LocalDate dataRegistrazione, LocalDate dataUltimoAccesso, boolean attivo, int tentativi, boolean bloccato, long id_ruolo) {
        this.id = id;
        this.nome = nome;
    ...
    public int hashCode() {
        ...
        hash = 97 * hash + (int) (this.tentativi ^ (this.tentativi >>> 32));
        hash = 97 * hash + (this.bloccato ? 1 : 0);
        hash = 97 * hash + (int) (this.id_ruolo ^ (this.id_ruolo >>> 32));
        return hash;
    }
